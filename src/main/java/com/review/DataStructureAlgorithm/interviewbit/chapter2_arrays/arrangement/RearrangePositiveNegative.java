// Geeks for Geeks: https://www.geeksforgeeks.org/rearrange-positive-and-negative-numbers-publish/
...
package com.review.DataStructureAlgorithm.interviewbit.chapter2_arrays.arrangement;

public class RearrangePositiveNegative {
	public static void main(String args[]) {
		int input[] = {-7,-9,1,2,3,-5,1,-2,-3,0,-1,2,3};
